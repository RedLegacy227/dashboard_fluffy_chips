...
try:
    ...
    if "Home" in data.columns and "Away" in data.columns:
        ...
        try:
            ...
            width = 0.35
            ax.bar(x - width/4, home_half_data_scored, width, label=f'{selected_home} Scored', color='blue')
            ax.bar(x - width/4, home_half_data_conceded, width, label=f'{selected_home} Conceded', color='darkblue')
            ax.bar(x + width/4, away_half_data_scored, width, label=f'{selected_away} Scored', color='red')
            ax.bar(x + width/4, away_half_data_conceded, width, label=f'{selected_away} Conceded', color='darkred')
            ax.set_xticks(x)
