...
with tab4:
    ...
    if data is not None:
        try:
            ...
            back_home_flt = data[(data['Elo_Difference'] > 75) & (data["Perc_Wins_FT_Home"] >= 80)& (data["FT_Odd_H"] <= 3.00) & (data['Tilt_Home'] > 1)]
...
with tab5:
    ...
    if data is not None:
        try:
            ...
            back_away_flt = data[(data['Elo_Difference'] < -75) & (data["Perc_Wins_FT_Away"] >= 80) & (data["FT_Odd_A"] <= 3.00) & (data['Tilt_Away'] < 1 )]
